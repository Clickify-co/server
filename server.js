...
sentry.init({
  dsn :
      'https://1c683ce30a9a49699f2061a314493f1d@o386985.ingest.sentry.io/5221824'
});
...
intializePassport(passport, async (email) => await userCollection.findOne({
...
app.get('/user/login', authCheckers.checkUnAuthenticated,
        (req, res) => {res.render('login.ejs')})
app.use('/user/register', authCheckers.checkUnAuthenticated,
        (req, res) => {res.render('signup.ejs')})
